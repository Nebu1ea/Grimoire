...
.v-scanner-line {
  ...
  height: 100vh;
  opacity: 0;
  background: linear-gradient(to bottom, transparent, rgba(6, 182, 212, 0.2), rgba(217, 70, 239, 0.2), transparent);
  box-shadow: 0 0 10px rgba(6, 182, 212, 0.1);
  will-change: transform;
  z-index: 5;
}

.v-line-1 { animation: scan-horizontal-move 20s linear infinite; }
.v-line-2 { animation: scan-horizontal-move 25s linear infinite 8s; }
</style>